...
const deleted: { organization_id?: string; service?: string }[] = [];
...
const SANDBOX_ADDRESS = "sim:agent-alice";
...
describe("S1: the band, and Reiniciar", () => {
  ...
  it("empties the drill: the conversation and its messages leave the store", async () => {
    ...
    // Scoped to this organization's drills, and to drills only.
    expect(deleted).toEqual([{ organization_id: ORG_A, service: "sandbox" }]);
